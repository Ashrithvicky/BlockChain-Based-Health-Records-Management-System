...
const Footer = () => {
  return (
    <div className="bg-black text-white p-6 bg-opacity-100">
      <div className="container mx-auto">
        <div className="flex justify-between items-start mb-6 mt-60">
          ...
          <div className="w-1/3">
            ...
            <p>
              <span className="font-bold">Address:</span> Thiruvalam, Vellore,
              India
            </p>
            <p>
            ...
            <p>
              <span className="font-bold">Email:</span> projects@gmail.com
            </p>
          </div>
